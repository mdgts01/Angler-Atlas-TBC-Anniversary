...
function FishInfo:Create(uiParent)
    ...
    info.levelText:SetWidth(320)
    info.levelText:SetWordWrap(true)
    ...
    info.waterType:SetWidth(320)
    info.waterType:SetWordWrap(true)
    info.waterType:SetJustifyH("LEFT")
